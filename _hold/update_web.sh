...
rsync -avr -e "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null" --delete --delete-after --progress --log-file=$LOGDIR/rsync-guayaba.log $ORIGDIR $USER@$URL:/var/www/